...
public class ApplicationSplash extends javax.swing.JDialog {
    ...
    private void initComponents() {
		...
		if(vers.indexOf("windows") != -1){
			...
			try {
				setIconImage(Toolkit.getDefaultToolkit().getImage(ApplicationSplash.class.getResource("/com/coder/contacts/icons/ContactBook.png")));				
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null, "ERROR!\nImage icon not found!");
			}
		}else{
			Application.getApplication().setDockIconImage(new ImageIcon(getClass().getResource("/com/coder/contacts/icons/ContactBook.png")).getImage());
		}
        ...
        Background.setIcon(new ImageIcon(ApplicationSplash.class.getResource("/com/coder/contacts/icons/motion-line.gif"))); // NOI18N
